                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 d-flex align-items-center">
                                            <div class="numbers">
                                                ...
                                                <a href="/user/laporan/surat-masuk"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-8 d-flex align-items-center">
                                            <div class="numbers">
                                                <p class="card-category">Laporan</p>
                                                <a href="/user/laporan/surat-keluar" class="card-title">Surat Keluar </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-8 d-flex align-items-center">
                                            <div class="numbers">
                                                <p class="card-category">Laporan</p>
                                                <a href="/user/laporan/disposisi" class="card-title">Disposisi</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
