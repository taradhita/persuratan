    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('user.laporan-masuk')}}" method="get">
                        <div class="row">
                            <div class="col-md-4">
                                <label>Bulan</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <button type="submit" class="btn btn-primary" formaction="{{route('user.laporan-masuk.export')}}">Export</button>
                                <!--<a href="{{route('user.laporan-masuk.export')}}" class="btn btn-primary"> Export </a> -->
                                </div>
                            </div>
                        </div>    
